...
public partial class Pages_Pregunta_admin : System.Web.UI.Page
{
    ...
    protected void BttnAdd_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            pregunta.addQuestion(txt_pregunta.Text, txt_Porcentaje.Text, txt_RA.Text, txt_RN1.Text, txt_RN2.Text, txt_RN3.Text, DDLTipoPregunta.Text, Pregunta.image, int.Parse(DropDownListCodPrueba.Text), int.Parse(DropDownListCodTema.Text), 1206354);
    ...
    protected void BttnUp_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            pregunta.updateQuestion(txt_pregunta.Text, txt_Porcentaje.Text, txt_RA.Text, txt_RN1.Text, txt_RN2.Text, txt_RN3.Text, DDLTipoPregunta.Text, Pregunta.image, int.Parse(DropDownListCodPrueba.Text), int.Parse(DropDownListCodTema.Text), int.Parse(txt_Nump.Text), int.Parse(Session["User_id"].ToString()));
